...
exports.createUser = (email,password,fullName,emailPassword) => User.build({
    email: email,
    full_name: fullName,
    password: password,
...
exports.findUser = userId => User.findOne({
    where: { id: userId }
})
...
// TODO : hash the password
exports.changePassword = (id,value) => User.update({password: value},{
    where: {
        id: id
    }
})

exports.changeEmailPassword = (id,value) => User.update(
